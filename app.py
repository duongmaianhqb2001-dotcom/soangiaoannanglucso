...
<div class="main-header">
    ...
    <p>Tác giả: Dương Mai Anh - Trường TH quyết Tiến - ĐT: 033 2710 354</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Dương Mai Anh - Trường TH quyết Tiến - ĐT: 033 2710 354</p>/div>", unsafe_allow_html=True)
